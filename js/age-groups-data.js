...
// Builds a <select> with an "Unassigned" option plus one per age group,
// defaulting to `currentValue`. Shared by Settings' question admin and the
// Daily Reading page's quick "Q+" add-question modal.
